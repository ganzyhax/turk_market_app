                                  ...
                                  DropdownButton<String>(
                                    ...
                                    items: (state.lCategories as List<dynamic>)
                                      ...
                                      return DropdownMenuItem<String>(
                                        value: category,
                                        child: SizedBox(
                                            width: 185, child: Text(category)),
                                      );
                                    }).toList(),
                                    onChanged: (newValue) {
                                      int index = (state.lCategories)
                                          .indexOf(newValue!);

                                      selectedCategory =
                                          state.lCategories[index];

                                      indexSelectedCategory = index;

                                      selectedSubCategory =
                                          state.lSubCategories[
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  ...
                                  DropdownButton<String>(
                                    ...
                                    onChanged: (newValue) {
                                      int index = (state.lSubCategories[
                                                      indexSelectedCategory]
                                                  ['subCategories']
                                              as List<dynamic>)
                                          .indexOf(newValue!);
